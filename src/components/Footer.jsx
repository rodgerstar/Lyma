        ...
        overflow-hidden' id='Footer'>
            ...
            justify-between items-start'>
                <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                    <img src={assets.logo_dark} alt="Lyma Dark Logo"/>
                    <p className='text-gray-400 mt-4'>
                        Lyma has a skilled team of engineers and technicians ready to handle projects across East
                        Africa.
                        Supported by local and international suppliers, we maintain a wide stock of spare parts for air
                        compressors and equipment related to steam and compressed air generation.
                    </p>
                </div>
                ...
                <div className='w-full md:w-1/3'>
                    ...
                    <p className='text-gray-400 mb-4 max-w-80'>The latest news, updates and resources, sent to your
                        inbox
                        weekly</p>

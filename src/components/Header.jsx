    ...
    return (
        ...
        items-center w-full overflow-hidden' style={{backgroundImage:"url('/header_img.png')"}} id='Header'>
         ...
         <motion.div
            ...
            text-white'>
                <h2 className='text-5xl sm:6xl md:text-[65px] inline-block
                max-w-3xl font-semibold pt-20'>Comprehensive Engineering Services for Industrial Excellence</h2>
                <div className='space-x-6 mt-16'>
                    <a href="#Projects" className='border border-white px-8
                    py-3 roundend'>Projects</a>
                    <a href="#Contact" className='bg-blue-500 border-white px-8
